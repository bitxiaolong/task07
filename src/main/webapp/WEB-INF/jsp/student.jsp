...
<%--    <title>首页</title>--%>
<%--    <link href="../css-5/bootstrap.min.css" rel="stylesheet" type="text/css">--%>
<%--    <link href="../bootstrap-3.3.5-dist/css/bootstrap.css">--%>
<%--    <link href="../css-5/Untitled-3.css" rel="stylesheet" type="text/css">--%>
<%--    <link href="../css-5/Untitled-1base.css" rel="stylesheet" type="text/css">--%>
<%--</head>--%>
<%--<body>--%>
<div id="myCarousel" class="carousel slide">
    ...
    <div class="carousel-inner">
        <div class="item active">
            <img alt="First slide" src="${pageContext.request.contextPath}/static/images/547567.jpg">
        </div>
        <div class="item">
            <img alt="Second slide" src="${pageContext.request.contextPath}/static/images/547567.jpg">
        </div>
        <div class="item">
            <img alt="Third slide" src="${pageContext.request.contextPath}/static/images/547567.jpg">
        </div>
        <div class="item">
            <img alt="Third slide" src="${pageContext.request.contextPath}/static/images/547567.jpg">
        </div>
    ...
    <div class="main-c row">
        ...
        <ul class="list-unstyled text-center">
            <c:forEach var="student" items="${students}">
                <li class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                    <div>
                        <img src="${student.photo}" height="108" width="108">
                        <span>${student.title}:${student.name}</span>
